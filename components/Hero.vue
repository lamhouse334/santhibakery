...
<template>
	<main
		class="mx-auto bg-gradient-to-r from-primary-800 via-primary-900 to-primary-800 ... lg:max-w-8xl px-5 lg:px-0 pt-14 lg:pt-12 bgimg">
		<h1 class="capitalize font-semibold text-[38px] lg:text-7xl text-center leading-snug text-white">			
			...
			<!-- <span class="font-extrabold bg-clip-text text-primary-500 uppercase">Welcome to</span> -->
			<!-- <span data-text="Welcome to Santhi Bakery" class="uppercase">Welcome to Santhi Bakery</span> -->
		</h1>
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway:400,400i,700">
			<div class="atext">
  				<div class="typewriter">Welcome to Santhi Bakery</div>
			</div>
